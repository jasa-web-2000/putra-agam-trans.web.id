...
$rute = [
  ...
  // 
  "Travel Pamekasan Surabaya",
  "Travel Pamekasan Malang",
  "Travel Pamekasan Batu",
  "Travel Pamekasan Madiun",
  "Travel Pamekasan Kediri",
  "Travel Pamekasan Blitar",
  "Travel Pamekasan Mojokerto",
  "Travel Pamekasan Pasuruan",
  "Travel Pamekasan Banyuwangi",
  "Travel Pamekasan Bojonegoro",
  "Travel Pamekasan Bondowoso",
  "Travel Pamekasan Gresik",
  "Travel Pamekasan Jember",
  "Travel Pamekasan Jombang",
  "Travel Pamekasan Lamongan",
  "Travel Pamekasan Lumajang",
  "Travel Pamekasan Magetan",
  "Travel Pamekasan Nganjuk",
  "Travel Pamekasan Ngawi",
  "Travel Pamekasan Pacitan",
  "Travel Pamekasan Ponorogo",
  "Travel Pamekasan Probolinggo",
  "Travel Pamekasan Sidoarjo",
  "Travel Pamekasan Situbondo",
  "Travel Pamekasan Trenggalek",
  "Travel Pamekasan Tuban",
  "Travel Pamekasan Tulungagung",
  ...
  // 
  "Travel Surabaya Pamekasan",
  "Travel Malang Pamekasan",
  "Travel Batu Pamekasan",
  "Travel Madiun Pamekasan",
  "Travel Kediri Pamekasan",
  "Travel Blitar Pamekasan",
  "Travel Mojokerto Pamekasan",
  "Travel Pasuruan Pamekasan",
  "Travel Banyuwangi Pamekasan",
  "Travel Bojonegoro Pamekasan",
  "Travel Bondowoso Pamekasan",
  "Travel Gresik Pamekasan",
  "Travel Jember Pamekasan",
  "Travel Jombang Pamekasan",
  "Travel Lamongan Pamekasan",
  "Travel Lumajang Pamekasan",
  "Travel Magetan Pamekasan",
  "Travel Nganjuk Pamekasan",
  "Travel Ngawi Pamekasan",
  "Travel Pacitan Pamekasan",
  "Travel Ponorogo Pamekasan",
  "Travel Probolinggo Pamekasan",
  "Travel Sidoarjo Pamekasan",
  "Travel Situbondo Pamekasan",
  "Travel Trenggalek Pamekasan",
  "Travel Tuban Pamekasan",
  "Travel Tulungagung Pamekasan",
        ...
        <div class="flex items-center">
          <nav>
            <button
              title="open nav"
              id="openNav"
              class="bg-primary hover:bg-yellow-500 p-1 rounded md:hidden">
              <svg
            ...
            <!-- laptop -->
            <ul
              class="hidden md:flex flex-col md:flex-row gap-8 lg:gap-11 [&_li]:flex [&_li]:items-center [&_li_a]:font-medium [&_li_a]:text-slate-700 hover:[&_li_a]:text-yellow-500 hover:[&_li]:scale-110 hover:[&_li]:transition-all">
              <?php if (count($menu) > 0) : ?>
              ...
              <a
                href="<?= $link_whatsapp ?>"
                target="_blank"
                class="flex gap-2 px-5 py-2 bg-primary hover:bg-yellow-500 text-slate-200 rounded-lg w-min">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <ul
              ...
              id="popupNav">
              <div
                class="bg-white h-full rounded flex p-5 flex-col md:flex-row gap-5 [&_li]:flex [&_li]:items-center [&_li_a]:font-medium [&_li_a]:text-slate-700 hover:[&_li_a]:text-yellow-500 hover:[&_li]:transition-all hover:[&_li_a]:scale-110 relative">
                <button
                  title="close nav"
                  id="closeNav"
                  class="absolute right-5 top-5 bg-primary hover:bg-yellow-500 p-1 rounded md:hidden">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
  ...
  <main class="overflow-x-hidden">
      ...
      <div
        ...
        <div
          ...
          <div class="md:!col-span-7 p-5 md:p-10 md:-top-10 lg:p-20 z-10">
            ...
            <div class="flex gap-x-5 mt-7">
              <a
                href="<?= $link_whatsapp ?>"
                target="_blank"
                class="flex gap-2 px-5 py-2 border-2 border-primary hover:border-yellow-500 bg-primary hover:bg-yellow-500 text-slate-200 rounded-lg w-min top-0 hover:top-2 transition-all duration-700 relative">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <a
                href="#rute-travel"
                class="flex gap-2 px-5 py-2 border-2 border-slate-200 hover:border-yellow-500 bg-slate-200 hover:bg-yellow-500 text-slate-800 hover:text-slate-200 rounded-lg w-min top-0 hover:top-2 transition-all duration-700 relative">
                Rute
              </a>
            </div>
          </div>
          <div class="md:!col-span-5 p-5 md:p-10 md:-top-10 lg:p-20 z-10">
            <div
              class="bg-white rounded-2xl border-b-8 border-yellow-500 shadow-lg p-5 px-7">
              ...
              <form
                ...
                <div class="col-span-full text-sm">
                  ...
                  <div class="mt-1">
                    <input
                      ...
                      id="nama"
                      autocomplete="off"
                      class="cursor-pointer block w-full rounded-md border-0 py-1.5 px-2 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-yellow-500 placeholder:text-gray-400 bg-slate-50" />
                  </div>
                </div>
                ...
                <button
                  class="col-span-full px-5 py-2 border-2 border-primary hover:border-yellow-500 bg-primary hover:bg-yellow-500 text-slate-200 rounded-lg transition-all relative"
                  type="submit">
                  Pesan Sekarang
                </button>
              </form>
    ...
    <section class="container my-20" id="rute-travel">
      <div class="">
        ...
        <div
          class="grid grid-cols-12 gap-x-5 gap-y-7 [&>div]:col-span-6 [&>div]:sm:col-span-4 [&>div]:md:col-span-3 [&>div]:lg:col-span-2 [&>div]:rounded-xl [&>div]:border [&>div]:shadow-xl [&>div]:overflow-hidden [&>div]:bg-white [&>div]:relative [&>div>a]:absolute [&>div>a]:inset-0 [&_img]:border-b [&>div_div]:p-4 [&>div_div]:md:px-5 [&>div_div]:lg:px-6 [&_h3]:line-clamp-3 [&_h3]:text-sm [&_h3]:text-slate-700 hover:[&_h3]:text-yellow-500 [&_h3]:z-10 [&_h3]:relative [&_h3]:cursor-pointer [&_svg]:size-4 [&_svg]:mx-2 [&_svg]:py-0.5 [&_svg]:inline-block">
          <?php if (count($rute) > 0) : ?>
    ...
    <!-- Tentang Kami -->
    <section id="tentang-kami" class="bg-gradient-to-tr from-primary to-yellow-500 py-20">
      <div class="container">
        <div class="grid grid-cols-12 gap-8">
          ...
          <div class="col-span-full md:col-span-6">
            <div class="text inner-container">
              <h2 class="line-h2 left-12 text-slate-50 before:!bg-yellow-300 after:!bg-yellow-300">Tentang Kami</h2>
    ...
    <!-- Kota Populer -->
    <section class=" mb-20 bg-yellow-50">
      <div class="container">
        <div class="py-20">
          <div class="text-center inner-container">
          ...
          <div
            class="grid grid-cols-8 gap-x-6 gap-y-10 [&>*]:col-span-full [&>*]:sm:col-span-4 [&>*]:md:!col-span-2 [&>*]:border [&>*]:relative [&>*]:min-h-96 md:[&>*]:min-h-80 [&>*]:rounded-xl [&>*]:shadow-xl [&>*]:cursor-pointer [&>*]:overflow-hidden [&>*]:before:absolute [&>*]:before:content-[''] [&>*]:before:z-[2] [&>*]:before:inset-0 [&>*]:before:bg-slate-950/55 [&_img]:w-full [&_img]:h-full [&_img]:object-cover [&_img]:absolute [&_img]:inset-0 [&_img]:scale-100 [&_img]:transition-all [&_img]:duration-500 [&>div>div]:z-10 [&>div>div]:relative [&>div>div]:p-5 [&>div>div]:text-center [&>div>div]:flex-col [&>div>div]:flex [&>div>div]:justify-between [&>div>div]:h-full [&_h3]:text-slate-50 [&_a]:col-span-full [&_a]:px-5 [&_a]:py-2 [&_a]:border-2 [&_a]:border-primary hover:[&_a]:border-yellow-500 [&_a]:bg-primary hover:[&_a]:bg-yellow-500 [&_a]:text-slate-200 [&_a]:rounded-lg [&_a]:transition-all [&_a]:relative">
            <?php if (count($kota) > 0) : ?>
    ...
    <section class="container my-20">
      <div class="w-full">
        <div
          class="bg-gradient-to-tr from-primary to-yellow-500 rounded-3xl p-8 text-center sm:p-16 md:px-24 md:py-20 lg:px-28">
    ...
    <!-- Galeri -->
    <section class="bg-yellow-50 my-20 py-20"
      id="galeri">
      <div class="container">
        <div class="">
          <div class="text-center inner-container">
    ...
    <!-- Kontak -->
    <section class="bg-yellow-50 mt-20 py-20"
      id="kontak">
      <div class="container">
        <div class="">
          <div class="text-center inner-container">
        ...
        <?php if ($iframe) :  ?>
          <iframe
            ...
            src="<?= $iframe ?>"
            allowfullscreen=""
            class="w-full h-60 border-4 brightness-75 hover:brightness-100 transition-all duration-700 shadow-lg rounded-lg border-yellow-500"
